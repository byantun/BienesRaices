...
describe ('Carga la Pagina principal', () => {
    it('Prueba el Header de la página principal', () =>{
        ...
        cy.get('[data-cy="heading-sitio"]').invoke('text').should('equal','Venta de Casa y Departamentos Exclusivos de Lujo');
    ...
    it('Prueba el bloque de Contacto ', () => {
        ...
        cy.get('[data-cy="imagen-contacto"]').find('a').invoke('attr', 'href').then(href => { cy.visit(href)});
    ...
    it('Prueba el bloque de Blog y testimoniales', () => {
